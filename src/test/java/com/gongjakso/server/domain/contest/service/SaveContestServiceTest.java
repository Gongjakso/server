...
public class SaveContestServiceTest {
    ...
    @BeforeEach
    void setup(){
        adminMember = MemberUtilTest.buildMemberByType(MemberType.ADMIN);
        generalMember = MemberUtilTest.buildMemberByType(MemberType.GENERAL);

        contestReq = ContestUtilTest.buildContest();
