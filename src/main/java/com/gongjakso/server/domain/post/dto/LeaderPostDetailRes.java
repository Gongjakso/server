...
public record LeaderPostDetailRes(
        @Schema(
    ...
    public static LeaderPostDetailRes of(String role, Long currentId, Post post, int currentPerson) {
        return LeaderPostDetailRes.builder()
